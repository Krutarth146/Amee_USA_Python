...
#     print(y,z,sep='\t')   # key, values
for key,value in dict2.items():   # ('roll', 34), ('Marks' , 90.89) ......
    print(key,value)
...
x = 90.10
print(int(float(x)))  # Explicit Typecasting  # 90
...
print(f+v)  # Implicit typecasting  # 91
